...
public final class GlobalConfig {
    ...
    public static final Map<CatOutfitType, ForgeConfigSpec.ConfigValue<Number>> CAREER_DAMAGE_COEFFICIENTS = new EnumMap<>(CatOutfitType.class);
    ...
    private static final Map<String, ForgeConfigSpec.ConfigValue<Number>> SWITCH_VALUES = new java.util.LinkedHashMap<>();
