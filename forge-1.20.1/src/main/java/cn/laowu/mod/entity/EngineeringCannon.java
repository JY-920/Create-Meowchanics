...
public final class EngineeringCannon extends Entity {
    ...
    @Override public double getPassengersRidingOffset() { return SEAT_TOP; }
    @Override protected void positionRider(Entity passenger, Entity.MoveFunction move) {
        if (!hasPassenger(passenger)) return;
        Vec3 seat = position().add(seatOffset());
    ...
    public boolean fire(Cat cat, LivingEntity target) {
        ...
        level.playSound(null, blockPosition(), net.minecraft.sounds.SoundEvents.GENERIC_EXPLODE,
