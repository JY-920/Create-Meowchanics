...
public final class InfiltratingRecipe extends BasinRecipe {
    ...
    private static final IRecipeTypeInfo TYPE_INFO = new IRecipeTypeInfo() {
        ...
        @SuppressWarnings("unchecked")
        @Override public <T extends RecipeType<?>> T getType() {
            return (T) LaoWuMod.INFILTRATING_TYPE.get();
        }
    };

    public InfiltratingRecipe(ProcessingRecipeBuilder.ProcessingRecipeParams params) {
    ...
    public boolean isCatToolRepair() {
        return CAT_TOOL_REPAIR_ID.equals(getId());
    }

    public boolean isPotionArrow() {
        return POTION_ARROW_ID.equals(getId());
    }
}
