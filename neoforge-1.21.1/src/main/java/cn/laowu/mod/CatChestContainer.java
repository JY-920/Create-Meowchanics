...
/** A live inventory view backed by the owning cat's persistent NeoForge data. */
public final class CatChestContainer extends SimpleContainer {
    ...
    public void setChanged() {
        super.setChanged();
        if (!loading) {
            cat.getPersistentData().put(CatChestData.ITEMS_TAG, createTag(cat.registryAccess()));
