...
.filter(outfit -> outfit != CatOutfitType.NONE && !outfit.isPreviewOnly()).toList();
    ...
    public static final ModConfigSpec.IntValue DEATH_OUTCOME;
    public static final int DEFAULT_DEATH_ATTRIBUTE_LOSS = 20;
    public static final ModConfigSpec.BooleanValue DEATH_ATTRIBUTE_PENALTY_ENABLED;
    public static final ModConfigSpec.IntValue DEATH_ATTRIBUTE_LOSS;
    public static final ModConfigSpec.IntValue INTERNAL_BALANCE_REVISION;
    public static final ModConfigSpec SPEC;
    public static final Map<CatStat, ModConfigSpec.DoubleValue> MULTIPLIERS = new EnumMap<>(CatStat.class);
    public static final Map<CatOutfitType, ModConfigSpec.DoubleValue> CAREER_DAMAGE_COEFFICIENTS = new EnumMap<>(CatOutfitType.class);
    ...
    public static final ModConfigSpec.BooleanValue SHOW_HELL_RECIPES;
    public static final ModConfigSpec.BooleanValue WILD_CATS_FLEE;
    public static final ModConfigSpec.BooleanValue CATS_HISS;
