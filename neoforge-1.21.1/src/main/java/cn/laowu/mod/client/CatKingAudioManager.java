...
public final class CatKingAudioManager {
    ...
    private static final SoundEvent[] RECORDS = {
            SoundEvents.MUSIC_DISC_5.value(), SoundEvents.MUSIC_DISC_11.value(),
            SoundEvents.MUSIC_DISC_13.value(), SoundEvents.MUSIC_DISC_BLOCKS.value(),
            SoundEvents.MUSIC_DISC_CAT.value(), SoundEvents.MUSIC_DISC_CHIRP.value(),
            SoundEvents.MUSIC_DISC_FAR.value(), SoundEvents.MUSIC_DISC_MALL.value(),
            SoundEvents.MUSIC_DISC_MELLOHI.value(), SoundEvents.MUSIC_DISC_PIGSTEP.value(),
            SoundEvents.MUSIC_DISC_STAL.value(), SoundEvents.MUSIC_DISC_STRAD.value(),
            SoundEvents.MUSIC_DISC_WAIT.value(), SoundEvents.MUSIC_DISC_WARD.value(),
            SoundEvents.MUSIC_DISC_OTHERSIDE.value(), SoundEvents.MUSIC_DISC_RELIC.value()
    };
