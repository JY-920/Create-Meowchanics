...
/** Development-only wand for editing the saved trait profile. */
public final class TraitDebugWandItem extends Item {
    public TraitDebugWandItem(Properties properties) {
        super(properties);
    }
    ...
    private static InteractionResult openEditor(Player player, Entity target) {
        ...
        if (target instanceof Cat cat) {
            ...
            CatTraitData.ensure(edited, itemEntity.level().random);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context,
        ...
        tooltip.add(Component.translatable("tooltip.laowu.trait_debug_wand")
