...
/**
 * Lets NeoForge's normal shears pipeline treat cats exactly like other shearable
 ...
 */
@Mixin(Cat.class)
public abstract class CatShearableMixin implements IShearable {
    @Override
    public boolean isShearable(@Nullable Player player, @NotNull ItemStack item,
