...
public final class CareerFeedbackVisualProbe {
    ...
    private static void drawRings(Minecraft mc){
        ...
        var stack=RenderSystem.getModelViewStack();stack.pushMatrix();
        try(var guard=new CatPerformanceOutline.State();var framebuffer=new PerformanceSceneSnapshot.Target()){
            ...
            for(int test=0;test<cameras.length;test++){
                ...
                stack.identity();stack.translate(70,40,-30);RenderSystem.applyModelViewMatrix();
            ...
            stack.popMatrix();RenderSystem.applyModelViewMatrix();RenderSystem.setProjectionMatrix(originalProjection,sorting);
