...
public final class SpecialistVisualProbe {
    public static void verify(Minecraft mc) {
        ...
        try(var guard=new CatPerformanceOutline.State();var target=new PerformanceSceneSnapshot.Target()) {
            ...
            RenderSystem.restoreProjectionMatrix();view.popMatrix();RenderSystem.applyModelViewMatrix();
    ...
    private static void verifySuitTooltips() {
        ...
        for(var outfit:CatOutfitType.values()) {
            ...
            for(int mode=0;mode<3;mode++) {
                ...
                var event=new net.neoforged.neoforge.event.entity.player.ItemTooltipEvent(
                        stack,null,lines,net.minecraft.world.item.TooltipFlag.Default.NORMAL,net.minecraft.world.item.Item.TooltipContext.EMPTY);
