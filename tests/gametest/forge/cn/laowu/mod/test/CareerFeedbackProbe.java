...
public final class CareerFeedbackProbe {
    ...
    public static void waterFlowerPacket(GameTestHelper h){
        var data=new cn.laowu.mod.particle.NozzleFluidPuffData(new net.minecraftforge.fluids.FluidStack(net.minecraft.world.level.material.Fluids.WATER,1));
        var buffer=new net.minecraft.network.FriendlyByteBuf(io.netty.buffer.Unpooled.buffer());
        try{data.writeToNetwork(buffer);var copy=cn.laowu.mod.particle.NozzleFluidPuffData.DESERIALIZER.fromNetwork(LaoWuMod.NOZZLE_FLUID_PUFF.get(),buffer);
