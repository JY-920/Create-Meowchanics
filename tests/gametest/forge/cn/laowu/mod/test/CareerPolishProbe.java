...
public final class CareerPolishProbe {
    ...
    public static void agentAnimationSync(GameTestHelper h) {
        ...
        try {
            cn.laowu.mod.network.AgentMeleePacket.encode(packet,buffer);
            h.assertTrue(cn.laowu.mod.network.AgentMeleePacket.decode(buffer).equals(packet)&&!buffer.isReadable(),"S2C attack packet roundtrip");
