...
public final class CatPouchProbe {
    private static ServerPlayer player(GameTestHelper h) {
        ...
        var p=new ServerPlayer(level.getServer(),level,new GameProfile(UUID.randomUUID(),"pouch-probe"));
    ...
    private static CompoundTag data(ItemStack stack) { return stack.getOrCreateTag(); }
    ...
    public static void normalAndFlattenedRoundTrip(GameTestHelper h) {
        ...
        UUID owner=UUID.randomUUID();cat.setTame(true);cat.setOwnerUUID(owner);
