...
public final class EditorNetworkingProbe {
    private static ServerPlayer player(GameTestHelper h) {
        ...
        var player = new ServerPlayer(level.getServer(), level, new GameProfile(UUID.randomUUID(), "editor-probe"));
    ...
    private static CatEditorActionPacket roundTrip(GameTestHelper h, int menu, int action) {
        ...
        try {
            CatEditorActionPacket.encode(packet, buffer);
            var decoded = CatEditorActionPacket.decode(buffer);
