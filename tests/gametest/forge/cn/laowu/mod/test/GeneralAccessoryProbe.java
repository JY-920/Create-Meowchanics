...
public final class GeneralAccessoryProbe {
    ...
    private static final class ScriptedNestedHit {
        ...
        public void nested(net.minecraftforge.event.entity.living.LivingHurtEvent event) {
    ...
    private static final class CancelFinal {
        ...
        public void cancel(net.minecraftforge.event.entity.living.LivingDamageEvent event) {
    ...
    public static void canceledDamageDoesNotProc(GameTestHelper h){
        ...
        var listener=new CancelFinal();listener.victim=foe;net.minecraftforge.common.MinecraftForge.EVENT_BUS.register(listener);
