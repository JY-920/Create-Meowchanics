...
public final class PilotAndTacticsProbe {
    ...
    public static void legacyPilotInventory(GameTestHelper h) {
        ...
        var owner=new net.minecraft.server.level.ServerPlayer(level.getServer(),level,
                new com.mojang.authlib.GameProfile(java.util.UUID.randomUUID(),"legacy-pilot"),net.minecraft.server.level.ClientInformation.createDefault());
        ...
        var noItems=new net.neoforged.neoforge.event.entity.player.PlayerInteractEvent.EntityInteract(owner,hand,cat);
        ...
        for(var held:new net.minecraft.world.item.ItemStack[]{empty,
            ...
            CommonEvents.onCatInteract(new net.neoforged.neoforge.event.entity.player.PlayerInteractEvent.EntityInteract(owner,hand,cat));
        ...
        var denied=new net.neoforged.neoforge.event.entity.player.PlayerInteractEvent.EntityInteract(connectionStub,hand,cat);
    ...
    public static void passengerFlight(GameTestHelper h) {
        ...
        var owner=new net.minecraft.server.level.ServerPlayer(level.getServer(),level,
                new com.mojang.authlib.GameProfile(java.util.UUID.randomUUID(),"pilot-probe"),net.minecraft.server.level.ClientInformation.createDefault());
        owner.connection=connectionStub.connection;
    ...
    public static void autoArtillery32(GameTestHelper h) {
        ...
        var arena=new net.minecraft.world.phys.AABB(Vec3.atLowerCornerOf(origin.offset(-20,-1,-5)),
                Vec3.atLowerCornerOf(origin.offset(46,9,6)));
